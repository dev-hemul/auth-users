		...
		if (profileData.avatar === null) {
			return (
				<div className="p-4 mb-5 border ">
				  <strong className="block mb-5 text-gray-500 underline">Аватар доступний тільки в google авторизації!</strong>
		...
		<div
            ...
            {avatar()}
					...
					<p className="text-lg mb-4">
						<span
							className="font-medium text-gray-600">User ID:</span> {profileData.uid}
					</p>
					<p className="text-lg mb-4">
						<span
							className="font-medium text-gray-600">Ваш логін:</span> {profileData.login}
					</p>
					<p className="text-lg mb-4">
						<span
							className="font-medium text-gray-600">Ваш E-mail:</span> {profileData.email}
					</p>
				</div>
				<button
					type="button"
